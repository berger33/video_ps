...
| Fase | Entrega | Status |
|------|---------|--------|
| 0 | [Brief de conceito](docs/FASE0_BRIEF.md) | **em revisão** |
| 1 | Assets brutos (5–10 clipes 3–6 s) + índice | bloqueada |
...
## Stack previsto (a partir da Fase 2)

Python · OpenCV · Pillow · MoviePy · (Fase 4) librosa
